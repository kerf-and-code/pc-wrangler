...
export const CLASS_ACTIONS: ClassAction[] = [
  ...
  // Cleric and Paladin subclass Channel Divinity options, from Terry's worklist 2026-08-09.
  // Every one costs a single Channel Divinity use, so they all spend from the same pool the base
  // class already tracks. Subclass-gated, so a Light Domain cleric is not offered a War Domain
  // option they do not have.
  { className: "Cleric", subclass: "Arcana Domain", level: 2, name: "Arcane Abjuration",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: It must make a Wisdom save or be turned (and banished if CR is low enough)" },
  { className: "Cleric", subclass: "Death Domain", level: 2, name: "Touch of Death",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "When you hit a creature with a melee attack: You can use Channel Divinity to deal extra necrotic damage equal to 5 + twice your Cleric level" },
  { className: "Cleric", subclass: "Forge Domain", level: 2, name: "Artisan's Blessing",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Create a simple nonmagical item of metal or wood worth no more than 100 gp that you have seen before" },
  { className: "Cleric", subclass: "Grave Domain", level: 2, name: "Path to the Grave",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Choose one creature within 30 feet; the next time you or an ally hits it before the start of your next..." },
  { className: "Cleric", subclass: "Knowledge Domain", level: 2, name: "Knowledge of the Ages",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Choose one skill or tool" },
  { className: "Cleric", subclass: "Light Domain", level: 3, name: "Radiance of the Dawn",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Magic action: Emit a 30-foot flash of light that dispels magical darkness and forces creatures of your choice to make a..." },
  { className: "Cleric", subclass: "Nature Domain", level: 2, name: "Charm Animals and Plants",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Each beast or plant creature of your choice within 30 feet must make a Wisdom save or be charmed by you..." },
  { className: "Cleric", subclass: "Order Domain", level: 2, name: "Order's Demand",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Each creature of your choice within 30 feet that can see or hear you must make a Wisdom save or be charmed..." },
  { className: "Cleric", subclass: "Peace Domain", level: 2, name: "Balm of Peace",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Bonus action: Move up to your speed without provoking opportunity attacks and touch up to a number of creatures equal to..." },
  { className: "Cleric", subclass: "Tempest Domain", level: 2, name: "Destructive Wrath",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "When you roll lightning or thunder damage: You can use Channel Divinity to deal maximum damage instead of rolling" },
  { className: "Cleric", subclass: "Trickery Domain", level: 2, name: "Invoke Duplicity",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Create an illusory duplicate of yourself within 30 feet" },
  { className: "Cleric", subclass: "Twilight Domain", level: 2, name: "Twilight Sanctuary",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Creatures of your choice that end their turn inside regain hit points or can end one condition..." },
  { className: "Cleric", subclass: "War Domain", level: 2, name: "Guided Strike",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "When you or a creature within 30 feet misses with an attack roll: You can use your reaction (or action in some versions) to give a +10 bonus to the roll, potentially..." },
  { className: "Paladin", subclass: "Oath of Conquest", level: 3, name: "Conquering Presence",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Each creature of your choice within 30 feet must make a Wisdom save or be frightened of you for 1 minute" },
  { className: "Paladin", subclass: "Oath of Conquest", level: 3, name: "Guided Strike",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "When you make an attack roll: You can use Channel Divinity to gain a +10 bonus to the roll" },
  { className: "Paladin", subclass: "Oath of Glory", level: 3, name: "Inspiring Smite",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Immediately after you deal damage with Divine Smite: You can use Channel Divinity to distribute temporary hit points equal to 2d8 + your Paladin level among..." },
  { className: "Paladin", subclass: "Oath of Glory", level: 3, name: "Peerless Athlete",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Bonus action: Gain advantage on Strength (Athletics) and Dexterity (Acrobatics) checks for 10 minutes, and your jump..." },
  { className: "Paladin", subclass: "Oath of Redemption", level: 3, name: "Emissary of Peace",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Bonus action: Gain advantage on Charisma (Persuasion) checks for 10 minutes" },
  { className: "Paladin", subclass: "Oath of Redemption", level: 3, name: "Rebuke the Violent",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "When an attacker within 30 feet deals damage to a creature other than you: You can use your reaction to force the attacker to make a Wisdom save, taking radiant damage equal to the..." },
  { className: "Paladin", subclass: "Oath of Vengeance", level: 3, name: "Abjure Enemy",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Choose one creature within 60 feet; it must make a Wisdom save or be frightened and have its speed reduced..." },
  { className: "Paladin", subclass: "Oath of Vengeance", level: 3, name: "Vow of Enmity",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Bonus action: Choose one creature within 10 feet; you gain advantage on attack rolls against it for 1 minute or until it..." },
  { className: "Paladin", subclass: "Oath of the Ancients", level: 3, name: "Nature's Wrath",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Spectral vines ensnare a creature within 10 feet; it must make a Strength or Dexterity save or be..." },
  { className: "Paladin", subclass: "Oath of the Ancients", level: 3, name: "Turn the Faithless",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Each fey or fiend within 30 feet that can see or hear you must make a Wisdom save or be turned for 1 minute" },
  { className: "Paladin", subclass: "Oath of the Crown", level: 3, name: "Champion Challenge",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Bonus action: Compel one creature within 30 feet to duel you; it has disadvantage on attacks against anyone but you for..." },
  { className: "Paladin", subclass: "Oath of the Crown", level: 3, name: "Turn the Tide",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Bonus action: Each creature of your choice within 30 feet that can hear you regains hit points equal to 1d6 + your..." },
  { className: "Paladin", subclass: "Oath of the Watchers", level: 3, name: "Abjure the Extraneous",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Each aberration, celestial, elemental, fey, or fiend within 30 feet must make a Wisdom save or be turned..." },
  { className: "Paladin", subclass: "Oath of the Watchers", level: 3, name: "Watcher's Will",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: For 1 minute they gain advantage on Intelligence, Wisdom, and Charisma saving throws" },
  { className: "Paladin", subclass: "Oathbreaker", level: 3, name: "Control Undead",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Choose one undead within 30 feet; it must make a Wisdom save or obey your commands for 24 hours (or until..." },
  { className: "Paladin", subclass: "Oathbreaker", level: 3, name: "Dreadful Aspect",
    cost: { resource: "Channel Divinity", amount: 1 },
    summary: "Action: Each creature of your choice within 30 feet must make a Wisdom save or be frightened of you for 1 minute" },
