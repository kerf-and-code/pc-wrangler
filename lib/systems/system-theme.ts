...
const LANCER: Vars = {
  ...
  "--stone-ink": "#e2ebf0", "--stone-ink-dim": "#93a6b1", "--stone-ink-faint": "#7e919c",
...
const PF2E: Vars = {
  ...
  "--stone-ink": "#f2e6d4", "--stone-ink-dim": "#c2a898", "--stone-ink-faint": "#a08476",
...
const DRAWSTEEL: Vars = {
  ...
  "--stone-ink": "#e9edf1", "--stone-ink-dim": "#9aa7b1", "--stone-ink-faint": "#818f99",
...
const DAGGERHEART: Vars = {
  ...
  "--stone-ink": "#f3ecf7", "--stone-ink-dim": "#b9abce", "--stone-ink-faint": "#998bb0",
...
const COC: Vars = {
  ...
  "--stone-ink": "#e5dcc2", "--stone-ink-dim": "#ada484", "--stone-ink-faint": "#988f72",
...
const POOLD10: Vars = {
  ...
  "--stone-ink": "#e9dede", "--stone-ink-dim": "#b09aa0", "--stone-ink-faint": "#947d82",
...
const DARKMATTER: Vars = {
  ...
  "--stone-ink": "#dbe7e3", "--stone-ink-dim": "#8ba59f", "--stone-ink-faint": "#738f89",
