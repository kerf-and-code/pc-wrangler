...
export default function TermsOfServicePage() {
  return (
    <LegalPage>
      ...
      <p>This product includes materials from the Daggerheart System Reference Document 1.0, &copy; Critical Role, LLC. Six Axes is an independent product published under the Darrington Press Community Gaming License and is not affiliated with, endorsed by, or sponsored by Darrington Press or Critical Role.</p>
      <p>Six Axes is not an official Lancer product; it is a third party work, and is not affiliated with Massif Press. Six Axes is published via the Lancer Third Party License. Lancer is copyright Massif Press.</p>
