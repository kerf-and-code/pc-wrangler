...
import { Modal } from "@/components/ui-forge/Modal";
...
//
// The dialog behaviour (Escape, focus trap, focus return, aria-modal, scroll lock) comes from the
// shared Modal shell; this file only supplies the panel content.
...
export default function EntryPreview({
  ...
  return (
    <Modal
      ...
      align="start"
      backdropStyle={{ zIndex: 200, padding: "4vh 3vw" }}
      panelStyle={{
        width: "100%", maxWidth: 1200, borderRadius: 12, overflow: "hidden",
        border: `1px solid ${C.line}`, boxShadow: "0 30px 80px rgba(0,0,0,.6)",
      }}
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 16px", background: C.surface2, borderBottom: `1px solid ${C.line}` }}>
        <span id="entry-preview-title" style={{ fontFamily: "ui-monospace, monospace", fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", color: C.muted }}>
