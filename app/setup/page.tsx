        ...
        <div style={{ ...card, marginTop: 14 }}>
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 8, flexWrap: "wrap" }}>
            ...
            <button type="button" onClick={copy}
              style={{ background: copied ? C.good : C.sun, color: C.ink, border: "none", borderRadius: FORGE_RADIUS,
          ...
          <div style={{ marginTop: 18, textAlign: "center" }}>
            <a href={`/record?share=${encodeURIComponent(share)}`}
              style={{ display: "inline-block", background: status === "waiting" ? "transparent" : C.good,
                color: status === "waiting" ? C.muted : C.ink, border: `1px solid ${status === "waiting" ? C.line : C.good}`,
