...
// Plain-text mirror of the answers above, for FAQPage structured data (schema.org requires plain
// text in acceptedAnswer, and the rendered answers are JSX). Keep in sync with FAQ when either
// changes. Questions must match the rendered ones exactly.
const FAQ_TEXT: { q: string; a: string }[] = [
  {
    q: "Is my table's audio kept?",
    a: "No, not for long. Session audio is deleted 60 days after it is recorded. The transcript and the moments drawn from it stay, because that is what the recap and the wiki are built from, but the recording itself does not.",
  },
  {
    q: "Who agrees to being recorded?",
    a: "The whole room. Recording only starts once everyone present agrees, and any player can withdraw consent at any time by telling the GM; their track is excluded from that session onward.",
  },
  {
    q: "Can I get my data out?",
    a: "Yes, all of it, in one JSON file with nothing withheld: your characters, your self-reports and how they changed over time, your dispositions, your threads, your check-ins, and your transcribed words. Export is a button on your account, not a support request.",
  },
  {
    q: "What happens if I delete my account?",
    a: "It deletes everything that is about you: your recordings, your transcribed words, your self-reports, your dispositions, your threads, your check-ins, and your chat. Your characters stay in their campaigns, unlinked from you.",
  },
  {
    q: "What does it actually record?",
    a: "Two things: the words spoken at the table, transcribed, and the mechanics - who rolled what, the damage, the saves, the hit points. On a supported virtual tabletop (D&D Beyond, Roll20, or Foundry) the numbers arrive automatically; in person it reads the numbers your table says out loud. You approve what gets filed into the wiki.",
  },
  {
    q: "Can players keep things private from the GM?",
    a: "Yes. Party chat is private to the players unless a player grants the GM a specific time window. Personal notes and the threads you are still owed are yours alone, and nobody else, GM included, sees them.",
  },
  {
    q: "Which systems does it support?",
  ...
  {
    q: "What does it cost?",
    a: "It is free while in pilot, with no card and no commitment. The no-login free tools will always be free. Longer-term pricing is still being worked out, and pilot tables will hear first.",
  },
  {
    q: "How do I get in?",
    a: "The pilot is invitation-based right now. Tell us about your table on the pilot page and we will get you in. It is early and honest feedback, including the unflattering kind, is exactly what it needs.",
  },
  {
    q: "In person or online?",
    a: "Both. Online tables on a supported virtual tabletop (D&D Beyond, Roll20, or Foundry) get mechanical capture automatically; in-person tables record over one microphone in the room, and it reads the rolls spoken aloud, which is the thing no audio-only tool does.",
  },
];
...
export default function FaqPage() {
  return (
    <SiteShell title="Questions and answers" tagline="The things a table asks first: consent, recording, and your data.">
      <JsonLd data={faqPageSchema(FAQ_TEXT)} />
